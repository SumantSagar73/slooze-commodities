      ...
      <footer className="grid gap-10 rounded-3xl border border-gray-200 bg-white px-8 py-10 text-sm shadow-sm transition dark:border-gray-800 dark:bg-gray-900 md:grid-cols-[minmax(0,1.5fr)_repeat(3,minmax(0,1fr))]">
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Ease of sourcing is our north star. Powerful analytics and refined filters make it simple to
              curate the commodities you need.
            </p>
          </div>
          <div className="flex items-center gap-3 text-gray-400 dark:text-gray-500">
            <a
              href="#"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 transition hover:border-gray-300 hover:text-gray-600 dark:border-gray-700 dark:hover:border-gray-600 dark:hover:text-gray-300"
            >
              <FaFacebookF size={14} />
            </a>
            <a
